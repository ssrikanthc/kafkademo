...
@Import(com.example.kafkademo.KafkaComposeTestContainersLiveTest.KafkaTestContainersConfiguration.class)
@SpringBootTest(classes = KafkaProducerConsumerApplication.class)
@DirtiesContext
@Testcontainers
public class KafkaComposeTestContainersLiveTest {
    ...
    private static final DockerComposeContainer kafka =
            new DockerComposeContainer(new File("src/test/resources/compose-test.yml"))
                    ...
                    .withExposedService(KAFKA_SERVICE , KAFKA_PORT, Wait.forListeningPort().withStartupTimeout(Duration.ofSeconds(360)))
    ...
    static class KafkaTestContainersConfiguration {
        ...
        public Map<String, Object> consumerConfigs() {
            ...
            props.put(ConsumerConfig.BOOTSTRAP_SERVERS_CONFIG, kafka.getServiceHost(KAFKA_SERVICE, KAFKA_PORT)+":"+kafka.getServicePort(KAFKA_SERVICE, KAFKA_PORT));
        ...
        public ProducerFactory<String, String> producerFactory() {
            ...
            configProps.put(ProducerConfig.BOOTSTRAP_SERVERS_CONFIG, kafka.getServiceHost(KAFKA_SERVICE, KAFKA_PORT)+":"+kafka.getServicePort(KAFKA_SERVICE, KAFKA_PORT));
