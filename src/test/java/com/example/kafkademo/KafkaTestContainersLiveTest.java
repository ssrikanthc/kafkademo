 ...
 * org.testcontainers.containers.KafkaContainer; import
 * org.testcontainers.junit.jupiter.Container; import
 * org.testcontainers.junit.jupiter.Testcontainers; import
 * org.testcontainers.utility.DockerImageName;
 * 
 * @RunWith(SpringRunner.class)
 * 
 * @Import(com.example.kafkademo.KafkaTestContainersLiveTest.
 ...
 * @DirtiesContext
 * 
 * @Testcontainers public class KafkaTestContainersLiveTest {
 * 
 * @Container public static KafkaContainer kafka = new
 ...
 * 
 * @Value("${test.topic}") private String topic;
 * 
 * @Test public void
 * givenKafkaDockerContainer_whenSendingtoDefaultTemplate_thenMessageReceived()
 * throws Exception { template.send(topic, "Sending with default template");
 ...
 * 
 * @Test public void
 * givenKafkaDockerContainer_whenSendingtoSimpleProducer_thenMessageReceived()
 ...
 * assertThat(consumer.getPayload(), containsString("embedded-test-topic")); }
 * 
 * @TestConfiguration static class KafkaTestContainersConfiguration {
 * 
 * @Bean ConcurrentKafkaListenerContainerFactory<Integer, String>
 ...
 * 
 * @Bean public ConsumerFactory<Integer, String> consumerFactory() { return new
